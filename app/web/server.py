...
def create_app(
    ...
    app.extensions["license_online_client"] = license_online_client
...
def run(
    ...
    app, socketio = create_app(
        ...
        watchdog, gain_assist, console_eq_sync, license_manager, license_online_client,
    )
